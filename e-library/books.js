...
async function renderBooks(filter) {
	...
	const booksLoading = document.querySelector(".books")

	booksLoading.classList += " books__loading"
	if (!books) 
		books = await getBooks()
	booksLoading.classList.remove("books__loading")
	console.log(books)
	...
	if (filter === "LOW_TO_HIGH") {
		...
		books.sort((a, b) => b.salePrice - a.salePrice ||b.originalPrice - a.originalPrice)
